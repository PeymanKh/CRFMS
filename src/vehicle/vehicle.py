...
Business Logics:
    - id is autogenerated and can not be changes.
    - Vehicle price can not be less that its VehicleClass base_price.
...
class Vehicle:
    ...
    def __init__(
        ...
        from src.vehicle.vehicle_class import VehicleClass  # To avoid circular import
        ...
        from src.vehicle.maintenance_record import (
            MaintenanceRecord,
